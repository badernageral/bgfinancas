...
public class Tabela<T> {
    ...
    public TableColumn<T,String> adicionarColuna(TableView<T> tabela, String titulo, String atributo){
        return this.adicionarColuna(tabela, titulo, atributo, null);
    }

    public TableColumn<T,String> adicionarColuna(TableView<T> tabela, String titulo, String atributo, Integer largura){
