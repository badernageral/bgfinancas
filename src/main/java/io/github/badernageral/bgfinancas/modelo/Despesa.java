...
public final class Despesa extends Banco<Despesa> implements Modelo, Grafico, Colavel {
    ...
    public static final String FXML_MODAL_CUPOM_FISCAL = MODULO + "/ModalCupomFiscal.fxml";
    ...
    private ComboBox<Item> comboAutoFiltro;
    private AutoFiltro<Item> itemAutoFiltro;
    ...
    public ComboBox<Item> getComboAutoFiltro(){
        return comboAutoFiltro;
    }
    
    public AutoFiltro<Item> getItemAutoFiltro(){
        return itemAutoFiltro;
    }
        ...
        try {
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    ...
                    String nomeDespesa = rs.getString(nomeItem.getAliasColuna());
                    if(rs.getString(parcela.getColuna())!=null){
                        nomeDespesa += " - "+rs.getString(parcela.getColuna());
                    }
    ...
    public ObservableList<Despesa> listarPeriodoAgrupado(LocalDate inicio, LocalDate fim, Categoria conta) {
        try {
