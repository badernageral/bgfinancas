...
//        System.out.println("Nome,Data,Quantidade,Valor");
//        tabelaLista.getItems().stream().forEach((Despesa a) -> {
//            System.out.println(a.getNomeItem()+","+a.getData()+","+a.getQuantidade()+","+a.getValor());
//        });
    }
