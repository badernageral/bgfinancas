...
public final class HomeControlador implements Initializable, Controlador {
                ...
                protected void updateItem(String item, boolean empty) {
                    ...
                    if (item != null && !empty) {
                        if(item.equals(idioma.getMensagem("credito"))){
                            setStyle("-fx-background-image: url(\"/imagem/outros/credito.png\");-fx-background-repeat: no-repeat;-fx-background-position: center center");
                        }else{
                            setStyle("-fx-background-image: url(\"/imagem/outros/poupanca.png\");-fx-background-repeat: no-repeat;-fx-background-position: center center");
                        }
                    }
                }
            };
    ...
    private void inicializarRelatorio(){
        ...
        Image imagemDespesas = new Image("/imagem/modulo/icon/despesas.png");
        ...
        Image imagemReceitas = new Image("/imagem/modulo/icon/receitas.png");
        ...
        Image imagemTransferencias = new Image("/imagem/modulo/icon/transferencias.png");
        ...
        Image imagemGrupos = new Image("/imagem/modulo/icon/grupos.png");
        ...
        Image imagemPlanejamento = new Image("/imagem/modulo/icon/planejamento_mini.png");
