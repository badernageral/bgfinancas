...
public final class Ajuda {
    ...
    private final Font fonte = Font.loadFont(getClass().getResource("/fonte/Ubuntu-L.ttf").toExternalForm(), 14);
    ...
    private double getLarguraTexto(String texto){
        ...
        try{
            ...
            if(c.getNode()!=null){
                ...
                if(c.getPosicao()==Posicao.BAIXO){
                    ...
                    double linhas = this.getLarguraTexto(c.getMensagem())/largura;
