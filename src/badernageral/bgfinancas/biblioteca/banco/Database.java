    ...
    public static void popularBanco(){
        ...
        if(Configuracao.getPropriedade("idioma").equals("en_US")){
            ...
            if(new Despesa().listar().isEmpty()){
                banco.executeUpdate("INSERT INTO DESPESAS VALUES(0,1,0,20.00,60.00,'"+data+"','08:18:04')");
                banco.executeUpdate("INSERT INTO DESPESAS VALUES(1,1,1,1.00,100.00,'"+data+"','08:19:01')");
                banco.executeUpdate("INSERT INTO DESPESAS VALUES(2,0,2,1.00,10.00,'"+data+"','08:19:47')");
                banco.executeUpdate("INSERT INTO DESPESAS VALUES(3,0,3,1.00,5.00,'"+data+"','08:20:08')");
                banco.executeUpdate("INSERT INTO DESPESAS VALUES(4,1,4,2.00,30.00,'"+data+"','08:20:41')");
                banco.executeUpdate("INSERT INTO DESPESAS VALUES(5,1,5,1.00,3.00,'"+data+"','08:21:59')");
            ...
            if(new PlanejamentoComponente().listar().isEmpty()){
                banco.executeUpdate("INSERT INTO PLANEJAMENTO VALUES(0,"+LocalDate.now().getMonthValue()+","+LocalDate.now().getYear()+",900.00)");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_COMPONENTES VALUES(0,0,50.00)");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_COMPONENTES VALUES(0,1,75.00)");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_COMPONENTES VALUES(0,2,300.00)");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_COMPONENTES VALUES(0,3,200.00)");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_COMPONENTES VALUES(0,4,100.00)");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(0,'Water bill')");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(1,'Eletricity bill')");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(2,'Rent')");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(3,'Food')");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(4,'Gasoline')");
            }
            ...
            if(new PlanejamentoComponente().listar().isEmpty()){
                ...
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_COMPONENTES VALUES(0,3,200.00)");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_COMPONENTES VALUES(0,4,100.00)");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(0,'\u00c1gua')");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(1,'Energia')");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(2,'Aluguel')");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(3,'Alimenta\u00e7\u00e3o')");
                banco.executeUpdate("INSERT INTO PLANEJAMENTO_ITENS VALUES(4,'Gasolina')");
            }
            if(new Receita().listar().isEmpty()){                
                banco.executeUpdate("INSERT INTO RECEITAS VALUES(0,0,0,'"+Linguagem.getInstance().getNomeMes(LocalDate.now().getMonthValue())+" / "+LocalDate.now().getYear()+"',900.00,'"+data+"','15:28:52')");
