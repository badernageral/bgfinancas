...
public final class DespesasAgendadasControlador implements Initializable, Controlador {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tabela.adicionarColuna(tabelaLista, idioma.getMensagem("item"), "nomeItem").setMinWidth(150);
    ...
    public void acaoFiltrar(Boolean animacao){
        tabelaLista.setItems(new Despesa().setSomenteAgendamento().setMesAno(data.getMonthValue(),data.getYear()).listar());
    ...
    public void acaoAjuda() {
        Ajuda.getInstance().setObjetos(voltar,titulo,anterior,proximo,cadastrar,alterar,excluir,tabelaLista,barraInferior,listaGrupoController.getGridPane(),listaContaController.getGridPane());
        ...
        Ajuda.getInstance().capitulo(cadastrar, Posicao.BAIXO, idioma.getMensagem("tuto_desp_agen_6"));
        Ajuda.getInstance().capitulo(alterar, Posicao.BAIXO, idioma.getMensagem("tuto_desp_agen_7"));
        Ajuda.getInstance().capitulo(excluir, Posicao.BAIXO, idioma.getMensagem("tuto_desp_agen_8"));
        Ajuda.getInstance().capitulo(tabelaLista, Posicao.CENTRO, idioma.getMensagem("tuto_desp_agen_9"));
        Ajuda.getInstance().capitulo(barraInferior, Posicao.TOPO, idioma.getMensagem("tuto_desp_agen_10"));
        Ajuda.getInstance().capitulo(Arrays.asList(listaContaController.getGridPane(),listaGrupoController.getGridPane()), 
                Posicao.CENTRO, idioma.getMensagem("tuto_desp_agen_11"));
